                            ...
                            default:
                                ...
                                props.forEach(function(prop) {
                                    ...
                                    try {
                                        ...
                                        if (!_.checkError.compatibleConstructor(
                                                err,
                                                AssertionError
                                            )) {
                                            throw err
            ...
            function(require, module, exports) {
                ...
                module.exports = function(chai, util) {
                    ...
                    assert.notDeepInclude = function(exp, inc, msg) {
                        new Assertion(exp, msg, assert.notDeepInclude, true).not.deep.include(
                            inc
                        )
                    }
                    ...
                    assert.deepOwnInclude = function(exp, inc, msg) {
                        new Assertion(exp, msg, assert.deepOwnInclude, true).deep.own.include(
                            inc
                        )
                    }
